---
name: Bug Report
about: Create a detailed report about a deficiency in the LocalCent Core implementation.
...
**Impacts**
Describe which portion(s) of LocalCent Core may be impacted by this bug. Please tick at least one box.
...
Please provide details about the host environment. Much of this information can be found running: `witness_node --version`. 
 ...
 - LocalCent Version:   [e.g. 2.0.180425]
